...
* **Array of lines over rope:** Simpler, predictable, sufficient for real-world file sizes.
* **Logical cursor over pixel cursor:** Eliminates desync bugs across fonts and scrolling.
* **Viewport-based rendering:** Constant FPS independent of file size.
...
Systems software should not depend on heavy abstractions. Valence focuses on:
