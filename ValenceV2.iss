...
OutputDir=Output
OutputBaseFilename=Valence_V2_Setup
Compression=lzma
...
[Run]
Filename: "{app}\Valence.exe"; Description: "Launch Valence V2 now 😏"; Flags: nowait postinstall skipifsilent

[Messages]
WelcomeLabel1=Welcome to Valence V2 Setup
